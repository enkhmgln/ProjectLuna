...
window.alert('Тоглогч X хожлоо');
}
else if ((b7 == 'x' || b7 == 'X') && (b8 == 'x' ||
b8 == 'X') && (b9 == 'x' || b9 == 'X')) {
document.getElementById('print')
.innerHTML = "Тоглогч X хожлоо";
...
document.getElementById('print')
	.innerHTML = "Match Tie";
window.alert('2 ТОГЛОГЧ ТЭНЦСЭН');
}
else {
...
if (flag == 1) {
document.getElementById('print')
	.innerHTML = "Тоглогч X-ийн ээлж";
}
else {
document.getElementById('print')
	.innerHTML = "Тоглогч Y-ийн ээлж";
}
}
}
...
// Эндээс хойш функцууд нь тоглуулагчийн эргэлтийг шалгадаг
// ба X эсвэл Y гэсэн утгыг тавина
flag = 1;
function myfunc_3() {
if (flag == 1) {
